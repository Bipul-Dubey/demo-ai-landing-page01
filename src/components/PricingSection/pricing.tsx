...
const PopularBackground = () => (
  <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(240,119,119,0.1),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-1%,rgba(220,119,118,0.3),rgba(255,255,255,0))]" />
);
...
const PricingCard = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col gap-8 overflow-hidden rounded-2xl p-[2px]", // border gradient wrapper
        "bg-gradient-to-r from-orange-400 via-orange-300 to-blue-400 shadow-lg"
      )}
    >
      <div
        className={cn(
          "relative flex flex-col gap-8 rounded-2xl border bg-background p-6 shadow h-full",
          isHighlighted
      ...
      >
        ...
        {/* FEATURES SECTION WITH STRONGER BORDER */}
        <div className="flex-1 space-y-2 rounded-xl border-2 border-gradient-to-r from-orange-400 to-blue-400 p-3">
